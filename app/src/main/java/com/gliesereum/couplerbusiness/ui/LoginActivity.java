...
import com.gliesereum.couplerbusiness.data.json.notificatoin.UserSubscribe;
...
import static com.gliesereum.couplerbusiness.util.Constants.FIREBASE_TOKEN;
import static com.gliesereum.couplerbusiness.util.Constants.IS_LOGIN;
import static com.gliesereum.couplerbusiness.util.Constants.KARMA_USER_RECORD;
import static com.gliesereum.couplerbusiness.util.Constants.KARMA_USER_REMIND_RECORD;
...
import static com.gliesereum.couplerbusiness.util.Constants.USER_AVATAR;
                ...
                .enqueue(customCallback.getResponseWithProgress(new CustomCallback.ResponseCallback<UserResponse>() {
                    ...
                    public void onSuccessful(Call<UserResponse> call, Response<UserResponse> response) {
                        ...
                        if (response.body().getUser().getFirstName() == null ||
                            ...
                            saveUserInfo(response.body());
                            startActivity(new Intent(LoginActivity.this, CorporationActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK));
                        }
                        finish();
                    }
