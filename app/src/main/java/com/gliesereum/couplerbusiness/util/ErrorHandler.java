...
import com.gliesereum.couplerbusiness.ui.RegisterActivity;
import com.gliesereum.couplerbusiness.ui.SplashActivity;
            ...
            public void onResponse(Call<UserResponse> call, Response<UserResponse> response) {
                if (response.code() == 200) {
                    ...
                    if (FastSave.getInstance().getString(USER_NAME, "").equals("") || FastSave.getInstance().getString(USER_SECOND_NAME, "").equals("")) {
                        ...
                        activity.startActivity(new Intent(context, CorporationActivity.class));
                        activity.finish();
                    }
                } else {
                    try {
